...
if [[ -f .local_bashrc && -x .local_bashrc ]]; then
	source .local_bashrc
fi
...
__conda_setup="$('/home/tariq/miniconda3/bin/conda' 'shell.bash' 'hook' 2>/dev/null)"
if [ $? -eq 0 ]; then
	eval "$__conda_setup"
else
	if [ -f "/home/tariq/miniconda3/etc/profile.d/conda.sh" ]; then
		. "/home/tariq/miniconda3/etc/profile.d/conda.sh"
	else
		export PATH="/home/tariq/miniconda3/bin:$PATH"
	fi
fi
unset __conda_setup
# <<< conda initialize <<<
